...
def review_video(video_path, script, scene_count=None):
    ...
    with tempfile.TemporaryDirectory() as tmp:
        try:
            ...
            if not response.ok:
                return {"enabled":True,"passed":True,"warning":"Gemini visual QC HTTP "+str(response.status_code),"scene_reviews":[],"quality_gate":"unavailable"}
            ...
            return {"enabled":True,"passed":True,"warning":"Gemini visual QC skipped: "+str(error),"scene_reviews":[],"quality_gate":"unavailable"}
